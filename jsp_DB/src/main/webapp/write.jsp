...
<style>
	...
	#outside {border: 2px solid #d5d5d5; height: 800px; border-top-color: #3b4890;
...
<body>
	...
	<div id=outside>
		<form action="upload.jsp" method=post>
			...
			<textarea rows="40" cols="140" name=content></textarea><br>
			<input type=submit value=등록><button>취소</button>
		</form>
	</div>
</body>
</html>